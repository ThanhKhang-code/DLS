...
-- OFFSETS
local OFF_UID     = 0x0020786C
local OFF_GOLD    = 0x207C34
local OFF_DIAMOND = OFF_GOLD + 0x20
local OFF_DP      = OFF_GOLD + 0x3D48
...
local baseZ
for i = 1, #zs do
    if (zs[i].address & 0xFFF) == 0x38C then
        baseZ = zs[i].address
        break
    end
end
